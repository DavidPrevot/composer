...
class ArchiveDownloaderTest extends \PHPUnit_Framework_TestCase
{
    public function testGetFileName()
    {
        ...
        $downloader = $this->getMockForAbstractClass('Composer\Downloader\ArchiveDownloader', array($this->createMock('Composer\IO\IOInterface'), $this->createMock('Composer\Config')));
    ...
    public function testProcessUrl()
    {
        ...
        $url = $method->invoke($downloader, $this->createMock('Composer\Package\PackageInterface'), $expected);
